...
public class RayCast {
	...
	public static Vector3[] throwRay(ClientViewport viewport, float mouseX, float mouseY, float near, float far) {
		...
		ray[0] = GLStatic.unproject(viewport.modelMat, viewport.projMat, viewport, new Vector3(mouseX, mouseY, near));
		ray[1] = GLStatic.unproject(viewport.modelMat, viewport.projMat, viewport, new Vector3(mouseX, mouseY, far));
